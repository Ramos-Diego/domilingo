...
export default function Logo() {
  return (
    <Link href="/" passHref>
      <a
        tabIndex={-1}
        className="w-min px-2 py-1 flex gap-2 items-center cursor-pointer text-white rounded hover:shadow-md focus:outline-none bg-gray-100 dark:bg-gray-900 bg-gradient-to-tr from-blue-600 via-purple-600 to-red-600"
      ...
      >
        ...
        <div className="hidden lg:block text-lg font-bold">DOMILINGO</div>
      </a>
    </Link>
  )
}
